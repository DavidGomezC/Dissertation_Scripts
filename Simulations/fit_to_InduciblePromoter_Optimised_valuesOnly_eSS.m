...
function [out]=fit_to_InduciblePromoter_Optimised_valuesOnly_eSS(epccOutputResultFileNameBase,epccNumLoops,stepd,epcc_exps,global_theta_guess,globalSolv,localSolv)
