function [out]=fit_to_InduciblePromoter_Optimised_DE_dhc(epccOutputResultFileNameBase,epccNumLoops,stepd,epcc_exps,global_theta_guess)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    results_folder = strcat('InduciblePromoterDEdhc',datestr(now,'yyyy-mm-dd-HHMMSS'));
...
for i=1:numLoops
    ...
    % OPTIMIZATION
    inputs.nlpsol.nlpsolver='hyb_de_dhc';                                           % Differential evolution
