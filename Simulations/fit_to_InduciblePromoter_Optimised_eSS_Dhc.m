function [out]=fit_to_InduciblePromoter_Optimised_eSS_Dhc(epccOutputResultFileNameBase,epccNumLoops,stepd,epcc_exps,global_theta_guess)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    results_folder = strcat('InduciblePromotereSSdhc',datestr(now,'yyyy-mm-dd-HHMMSS'));
...
for i=1:numLoops
    ...
    inputs.exps.n_steps{iexp}=round(duration/stepDuration);         % Also used round(duration/stepDuration); Number of steps in the input
    ...
    % OPTIMIZATION
    inputs.nlpsol.nlpsolver='eSS';                                           % Differential evolution
    
    inputs.nlpsol.eSS.maxeval = 500000;
    inputs.nlpsol.eSS.maxtime = 600;
    inputs.nlpsol.eSS.local.solver = 'dhc';  % nl2sol not yet installed on my mac
    inputs.nlpsol.eSS.local.finish = 'dhc';  % nl2sol not yet installed on my mac
