function [out]=fit_to_InduciblePromoter_Optimised_DE1(epccOutputResultFileNameBase,epccNumLoops,stepd,epcc_exps,global_theta_guess)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    results_folder = strcat('InduciblePromoterDE1',datestr(now,'yyyy-mm-dd-HHMMSS'));
