...
function [out]=fit_to_InduciblePromoter_Optimised_valuesOnly(epccOutputResultFileNameBase,epccNumLoops,stepd,epcc_exps,global_theta_guess,globalSolv,localSolv,CR,F,strategy,pf)
    ...
    rng(1,'twister'); %rng shuffle keeps giving me an error;
    rngToGetSeed = rng;
...
for i=1:numLoops
    ...
    elseif strcmp(globalSolv, 'de') 
        ...
        inputs.nlpsol.DE.CR = CR;                                              % CR: crossover probability constant [0,1]
    ...
    elseif strcmp(globalSolv, 'sres') 
        ...
        inputs.nlpsol.SRES.itermax = round((500*1e3)/inputs.nlpsol.SRES.NP);        % maximum number of iterations ('generations')
